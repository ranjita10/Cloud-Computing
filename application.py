...
# create devices
device_name = ['Vartika']
dev_id = ['arn:aws:sns:us-east-1:998213733383:MyIotSNSTopic:fa4b0216-c3a7-429d-a048-f027419e5548']
devs = []  # set up a list to hold your devices
for i in range(len(device_name)):
    coor = GPS()
    devs.append(device.Device(device_name[i], coor[0], coor[1],light(),audio(),dev_id[i]))
